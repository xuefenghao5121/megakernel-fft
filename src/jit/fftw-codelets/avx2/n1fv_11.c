/* topic jit-anyN-fwd-inv R1 (DELTA F3, L-S): vendored upstream radix-11
 * leaf — common/n1fv_11.c is a byte-for-byte copy of
 * third_party/fftw/dft/simd/common/n1fv_11.c (md5-aligned with the R0
